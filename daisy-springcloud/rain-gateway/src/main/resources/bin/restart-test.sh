...
service_name="rain-gateway"
cd /u01/projectCAR/service/${service_name}/
#jar
project=rain-gateway-1.0.0-SNAPSHOT.jar
...
nohup /usr/local/java/bin/java ${JAVA_OPTS} -jar ${project} --spring.profiles.active=test > nohup.out 2>&1 &
