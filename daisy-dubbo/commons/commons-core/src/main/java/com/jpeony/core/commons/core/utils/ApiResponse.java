package com.jpeony.core.commons.core.utils;

import com.jpeony.core.commons.core.enums.ErrorCodeEnum;
...
public final class ApiResponse<T> implements Serializable {
    private static final long serialVersionUID = -7732021979337724457L;
