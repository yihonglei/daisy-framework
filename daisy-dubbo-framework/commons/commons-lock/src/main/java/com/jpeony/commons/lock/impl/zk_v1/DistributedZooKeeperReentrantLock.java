package com.jpeony.commons.lock.impl.zk_v1;

import com.jpeony.commons.lock.ApplicationContextUtils;
import com.jpeony.commons.lock.DistributedLock;
import com.jpeony.commons.lock.DistributedLockException;
import com.jpeony.commons.tool.zookeeperConfig.CuratorFrameworkClient;
...
/**
 * 分布式锁的第二种实现
 * 集成Zookeeper分布式锁之可重入互斥锁,在redis 分布式提供的扩展方式上增加zk实现
 * 使用配置方式:
 * lock:
 * zookeeper:
